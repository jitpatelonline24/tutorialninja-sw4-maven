...
public class AccountRegisterPageTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        Assert.assertEquals(actualYourAccountCreatedText, expectedYourAccountCreatedText, "My Account page error");
        Thread.sleep(2000);
//        verifyText(driver, By.xpath("//h1[contains(text(),'Your Account Has Been Created!')]"),"Your Account Has Been Created!");
        ...
        Assert.assertEquals(actualLogoutText, expectedLogoutText, "Logout message not displayed");
